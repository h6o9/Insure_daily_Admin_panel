<div class="main-sidebar sidebar-style-2" style="background: #fff; ">
    ...
    <a href="{{url('admin/dashboard')}}"><img src="{{asset('public/frontend/assets/images/logo/InsureDaily_short_term_car_insurance_logo.webp')}}" class="admin-logo" style="width: 86%;" /></a>
